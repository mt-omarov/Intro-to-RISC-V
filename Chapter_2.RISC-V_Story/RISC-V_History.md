...
Установление добровольных стандартов в машиностроении началось более века назад. В конце 1980-х - 1990-х годов Тим Бернерс-Ли возглавил революцию 
...
технологической полезности в современной истории. Существует множество примеров, которые лежат в основе технологий, которыми мы пользуемся каждый день.
...
Будучи архитектурой набора команд, RISC-V сама по себе не является "открытым исходным кодом" так же, 
как открыто программное обеспечение, поскольку ISA не состоит из исходного кода. 
Тем не менее, это открытая спецификация, и она выпущена под лицензией Creative Commons. Другие компоненты в рамках RISC-V, такие как программное обеспечение 
и тесты соответствия, используют соответствующие лицензии (например, BSD и MIT), которые сохраняют разрешительное первоначальное намерение 
...
она требует сотрудничества между многими заинтересованными сторонами, защиты от патентных мошенников и других правовых нарушений, 
а также четкого пути к праву собственности для тех, кто рассчитывает получить средства к существованию в результате. 
RISC-V добилась огромного успеха благодаря своей приверженности полностью открытой архитектуре, защите, 
предусмотренной и согласованной всеми участниками в соглашении о членстве, внутренних правилах и полной и неуклонной приверженности сообществу.
...
Хотя проект в целом не имел федерального финансирования, Юнсуп Ли и Эндрю Уотерман получили некоторое финансирование от проекта DARPA POEM photonics, 
...
через MIT в качестве основного контракта с [Международным институтом компьютерных наук](http://www.icsi.berkeley.edu/icsi/) в качестве субконтракта.
...
Сама спецификация ISA, то есть кодировка набора инструкций, была выпущена под разрешительной лицензией (похожей на язык лицензии BSD), 
...
Программное обеспечение RISC-V находится в ведении соответствующих программных проектов с открытым исходным кодом.
...
Хотя DARPA не финансировала первоначальное определение RISC-V ISA, финансирование DARPA сыграло значительную роль в его последующем развитии. 
...
включая различные параллельные ускорители данных, является явной целью разработки ISA.
